...
!(function (t, e) {
    ...
    return (() => {
        ...
        var t = {
                21: (t, e, i) => {
                    ...
                    (e.GridStackDD = n),
                        (o.GridStack.prototype._setupAcceptWidget = function () {
                            if (this.opts.staticGrid || (!this.opts.acceptWidgets && !this.opts.removable)) return n.get().droppable(this.el, "destroy"), this;
                            let t,
                                e,
                                i,
                                s = (s, o, l) => {
                                    ...
                                    .on(this.el, "drop", (t, e, i) => {
                                        ...
                                        return (
                                            ...
                                            !!o &&
                                                ...
                                                this._gsEventHandler.dropped && this._gsEventHandler.dropped(Object.assign(Object.assign({}, t), { type: "dropped" }), l && l.grid ? l : void 0, s),
                                                window.setTimeout(() => {
                        ...
                        (o.GridStack.prototype._dragOrResize = function (t, e, i, s, o, n) {
                            ...
                            if ("drag" === e.type) {
                                ...
                                if ((this._extraDragRow !== u && this._updateContainerHeight(), s.x === a.x && s.y === a.y)) return;
                            } else if ("resize" === e.type) {
                                if (a.x < 0) return;
                                if ((r.Utils.updateScrollResize(e, t, n), (a.w = Math.round((i.size.width - h) / o)), (a.h = Math.round((i.size.height - g) / n)), s.w === a.w && s.h === a.h)) return;
                            ...
                            s._lastTried = a;
                            let c = { x: i.position.left + h, y: i.position.top + g, w: (i.size ? i.size.width : s.w * o) - h - d, h: (i.size ? i.size.height : s.h * n) - g - p };
                            if (this.engine.moveNodeCheck(s, Object.assign(Object.assign({}, a), { cellWidth: o, cellHeight: n, rect: c }))) {
                        ...
                        save(t = !0) {
                            ...
                            return (
                                ...
                                this.nodes.forEach((i) => {
                                    ...
                                    delete s.grid, t || delete s.el, s.autoPosition || delete s.autoPosition, s.noResize || delete s.noResize, s.noMove || delete s.noMove, s.locked || delete s.locked, e.push(s);
                                }),
                                e
                            );
                        }
                ...
                270: function (t, e, i) {
                    ...
                    class h {
                        constructor(t, e = {}) {
                            ...
                            if (
                                (o && o.gridstackNode && ((this.opts._isNested = o.gridstackNode), (this.opts._isNested.subGrid = this), this.el.classList.add("grid-stack-nested")),
                        ...
                        addWidget(t, e) {
                            ...
                            if ((this._writeAttr(i, e), this._insertNotAppend ? this.el.prepend(i) : this.el.appendChild(i), this._prepareElement(i, !0, e), this._updateContainerHeight(), r.subGrid && !r.subGrid.el)) {
                            ...
                            if (
                                ...
                                return (
                                    t.marginBottom === t.marginTop &&
                                        ...
                                        ((t.margin = t.marginTop), delete t.marginTop, delete t.marginRight, delete t.marginBottom, delete t.marginLeft),
                        ...
                        removeWidget(t, e = !0, i = !0) {
                            return (
                                h.getElements(t).forEach((t) => {
                                    ...
                                    s || (s = this.engine.nodes.find((e) => t === e.el)), s && (delete t.gridstackNode, l.GridStackDDI.get().remove(t), this.engine.removeNode(s, e, i), e && t.parentElement && t.remove());
                                }),
                        ...
                        _updateStyles(t = !1, e) {
                            ...
                            if (!this._styles) {
                                ...
                                (this._styles._id = t), (this._styles._max = 0), n.Utils.addCSSRule(this._styles, o, `min-height: ${i}${s}`);
                        ...
                        _prepareElement(t, e = !1, i) {
                            ...
                            return (i = this.engine.addNode(i, e)), n.Utils.same(i, s) || this._writeAttr(t, i), this._prepareDragDropByNode(i), this;
                        }
                        _writePosAttr(t, e) {
                            return (
                            ...
                            return (
                                ...
                                this._isAutoCellHeight &&
                                    (!e && this.opts.cellHeightThrottle
                                        ? (this._cellHeightThrottle || (this._cellHeightThrottle = n.Utils.throttle(() => this.cellHeight(), this.opts.cellHeightThrottle)), this._cellHeightThrottle())
                                        : this.cellHeight()),
                                this.engine.nodes.forEach((t) => {
                        ...
                        initMargin() {
                            ...
                            return (
                                ...
                                2 === i.length
                                    ...
                                    : ((t = n.Utils.parseHeight(this.opts.margin)), (this.opts.marginUnit = t.unit), (e = this.opts.margin = t.h)),
                                void 0 === this.opts.marginTop ? (this.opts.marginTop = e) : ((t = n.Utils.parseHeight(this.opts.marginTop)), (this.opts.marginTop = t.h), delete this.opts.margin),
                                void 0 === this.opts.marginBottom ? (this.opts.marginBottom = e) : ((t = n.Utils.parseHeight(this.opts.marginBottom)), (this.opts.marginBottom = t.h), delete this.opts.margin),
                                void 0 === this.opts.marginRight ? (this.opts.marginRight = e) : ((t = n.Utils.parseHeight(this.opts.marginRight)), (this.opts.marginRight = t.h), delete this.opts.margin),
                                void 0 === this.opts.marginLeft ? (this.opts.marginLeft = e) : ((t = n.Utils.parseHeight(this.opts.marginLeft)), (this.opts.marginLeft = t.h), delete this.opts.margin),
                ...
                849: (t, e) => {
                    Object.defineProperty(e, "__esModule", { value: !0 }), (e.DDManager = void 0), (e.DDManager = class {});
                },
                680: (t, e) => {
                    ...
                    class i {
                        ...
                        destroy() {
                            return this.moving && this._mouseUp(this.mouseDownEvent), this.el.removeEventListener("mousedown", 
                            height = $( window ).height(),
                            heightReady = height + "px",
                            gridCanvas.css({"height": heightReady}),
                            
                            this._mouseDown), this.host.removeChild(this.el), delete this.el, delete this.host, this;
                        }
                        _mouseDown(t) {
                ...
                593: (t, e) => {
                    ...
                    class i {
                        ...
                        static cloneDeep(t) {
                            const e = i.clone(t);
                            for (const s in e) e.hasOwnProperty(s) && "object" == typeof e[s] && "__" !== s.substring(0, 2) && (e[s] = i.cloneDeep(t[s]));
                            return e;
                        }
                    }
                    e.Utils = i;
